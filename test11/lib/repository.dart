import 'package:test11/state_model.dart';
...
class Repository {
  ...
  List _india = [
    ...
    {
      "state": "Bắc Kạn",
      "districts": ["TX Bắc Kạn - Tổ 9 - Phùng Chí Kiên /Công ty cổ phần đăng kiểm Bắc Kạn - 9701D"]
    },
    {
      "state": "Bạc Liêu",
      "districts": [ "Huyện Vĩnh Lợi-Xã Long Thạnh- QL 1 - Phường 7 /Trung tâm đăng kiểm xe cơ giới 9401V - Bạc Liêu"]
    },
    {
      "state": "Bắc Ninh",
      "districts": [
    ...
    {
      "state": "Bến Tre",
      "districts": ["TX Bến Tre -Số 7 - Nguyễn Văn Tư - P7 /Trung Tâm đăng kiểm xe cơ giới 7101S - Bến Tre", "Huyện Mỏ Cày Bắc-xã Tân Thành Bình-Ấp Tân Long 1-QL60/Trung Tâm đăng kiểm xe cơ giới 7102D - Bến Tre"]
    },
    {
      "state": "Bình Định",
      "districts": [
