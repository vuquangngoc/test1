...
class _MyAppState extends State<Page44> with WidgetsBindingObserver {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(
                      "Cảm ơn bạn đã mua bảo hiểm TNDS dành cho xe máy",
                  ...
                  Container(
                    ...
                    margin: const EdgeInsets.all(0.0),
                    child: Text(
                      "Ấn chỉ điện tử sẽ đc gửi về email của bạn",
                  ...
                  Container(
                    ...
                    margin: const EdgeInsets.all(0.0),
                    child: Text(
                      "hoặc qua ứng dụng SAUTO sau khi nhân viên bổ xung thông tin và xác nhận ",
                      style: TextStyle(fontSize: 11, color: Colors.grey[600],fontWeight: FontWeight.bold),
                    ),
